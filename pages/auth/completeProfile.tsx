...
function FieldError({ error }: { error: FieldError | undefined }) {
  ...
  return (
    <label className="label">
      <p className="label-text-alt text-xs italic tracking-wide text-error">{error.message}</p>
    </label>
  );
}
...
const CompleteProfile: React.FC = () => {
          ...
          updateContactDetailsUserMutaion.mutate(
            { id: contactDetailsID, userId: userID },
            {
              onSuccess: (res) => {
                ...
                if (userRole?.name === UserRoles.JOB_SEEKER) {
                  router.replace("/seeker/dashboard");
                } else if (userRole?.name === UserRoles.JOB_PROVIDER) {
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-5">
      ...
      <div className="card relative mt-10 w-full max-w-7xl rounded-3xl bg-base-200 p-10">
          ...
          <div className="grid grid-cols-2 gap-5">
            ...
            <div className="form-control w-full max-w-lg">
              ...
              <input
                ...
                className={`input ${errors.firstName ? "input-error" : ""} w-full bg-base-200`}
              />
            ...
            <div className="form-control w-full max-w-lg">
              ...
              <input
                ...
                className={`input ${errors.lastName ? "input-error" : ""} w-full bg-base-200`}
              />
            ...
            <div className="form-control w-full max-w-lg">
              ...
              <input
                ...
                type="date"
                className={`input ${errors.dateOfBirth ? "input-error" : ""} w-full bg-base-200`}
              />
              ...
              <div className="mt-auto flex flex-row items-center gap-5">
                ...
                <label htmlFor="male" className="relative">
                  <input
                    ...
                    type="radio"
                    className="radio h-16 w-16 rounded-xl border-0 checked:bg-base-200"
                    name="gender"
                    value="male"
                    id="male"
                  />
            ...
            <div className="form-control w-full max-w-lg">
              ...
              <input
                ...
                className={`input ${errors.postcode ? "input-error" : ""} w-full bg-base-200`}
              />
            ...
            <div className="form-control col-span-full w-full">
              ...
              <input
                ...
                className={`input ${errors.addressLine ? "input-error" : ""} w-full bg-base-200`}
              />
            ...
            <div className="form-control w-full max-w-lg">
              ...
              <input
                ...
                className={`input ${errors.city ? "input-error" : ""} w-full bg-base-200`}
              />
